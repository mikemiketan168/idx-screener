...
def load_tickers() -> List[str]:
    ...
    return [
        "BBCA.JK", "BBRI.JK", "BMRI.JK", "BBNI.JK", "ASII.JK", "TLKM.JK", "UNVR.JK", "HMSP.JK", "GGRM.JK", "INDF.JK",
        "BRIS.JK", "BNGA.JK", "BNLI.JK", "PGAS.JK", "PTBA.JK", "ADRO.JK", "ITMG.JK", "BUMI.JK", "HRUM.JK",
        "ICBP.JK", "MYOR.JK", "GOOD.JK", "ROTI.JK", "EXCL.JK", "ISAT.JK", "GOTO.JK", "BUKA.JK",
        "BSDE.JK", "CTRA.JK", "SMRA.JK", "PWON.JK", "APLN.JK", "JSMR.JK", "WIKA.JK", "WSKT.JK", "PTPP.JK",
        "ACES.JK", "MAPI.JK", "LPPF.JK", "ERAA.JK", "AUTO.JK", "SMSM.JK", "GJTL.JK",
        "KAEF.JK", "KLBF.JK", "SIDO.JK", "BRPT.JK", "MDKA.JK", "RAJA.JK", "CDIA.JK", "COAL.JK",
        "AALI.JK", "LSIP.JK", "SGRO.JK", "ARTO.JK", "DNET.JK", "WIFI.JK", "TOWR.JK", "TPIA.JK"
    ]
